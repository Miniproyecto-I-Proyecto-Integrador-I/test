...
const CreatePage = () => {
  ...
  const handleCreateTask = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        general: 'Ocurrió un error al guardar la tarea en el servidor.',
      });
    }
  };
  ...
  // Si el modal de subtareas está abierto, reemplazar la página completa por el formulario
          ...
          <div className="modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            {formStatus === 'success' && (
              <div className="success-state">
                ...
                <h2>¡Tarea creada!</h2>
                <p>
                  Tu tarea "{title}" ha sido guardada. Ahora haz clic en ella
                  para agregarle actividades.
                </p>
              </div>
            )}
          </div>
