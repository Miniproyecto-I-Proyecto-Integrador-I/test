...
const PostponeModal: React.FC<PostponeModalProps> = ({
  ...
  const titleId = 'postpone-modal-title';
  const descriptionId = 'postpone-modal-description';

  return (
    <div className="postpone-modal-overlay" onClick={onClose}>
      <div
      ...
      >
        ...
        <div className="postpone-modal-subtask">
          ...
          <span className="postpone-modal-subtask-title">
            {subtask.description}
          </span>
        </div>
