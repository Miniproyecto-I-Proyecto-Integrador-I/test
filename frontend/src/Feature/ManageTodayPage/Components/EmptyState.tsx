  ...
  return (
    <div className="today-empty-state">
      <div className="empty-state-visual">
        <div
          className="empty-state-bubble empty-state-bubble-outer"
          aria-hidden="true"
        ></div>
        <div
          className="empty-state-bubble empty-state-bubble-inner"
          aria-hidden="true"
        ></div>
        ...
        <div
          className="empty-state-accent accent-top-right"
          aria-hidden="true"
        ></div>
        <div
          className="empty-state-accent accent-bottom-left"
          aria-hidden="true"
        ></div>
      </div>
      ...
      <p className="empty-state-text">
        No tienes actividades pendientes en esta vista. Aprovecha para
        <br />
        ...
        >
          {hiddenOverdueCount > 0 && (
            ...
            >
              ...
              Tienes {hiddenOverdueCount}{' '}
              {hiddenOverdueCount === 1 ? 'tarea vencida' : 'tareas vencidas'}
            </button>
          )}
          {hiddenUpcomingCount > 0 && (
            <button
            ...
            >
              ...
              Tienes {hiddenUpcomingCount}{' '}
              {hiddenUpcomingCount === 1 ? 'tarea próxima' : 'tareas próximas'}
            </button>
          )}
        </div>
      )}
