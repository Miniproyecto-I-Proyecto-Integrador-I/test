...
const TodaySummaryCard: React.FC<TodaySummaryCardProps> = ({
  ...
  const percentage =
    Math.min(100, Math.round((totalNeededHours / dailyHoursLimit) * 100)) || 0;
      ...
      <div className="summary-progress-section">
        <div className="summary-progress-header">
          <span className="summary-progress-label">
            <Clock size={14} aria-hidden="true" /> Tu capacidad diaria normal (
            {dailyHoursLimit}h)
          </span>
        ...
        <div className="summary-progress-bar-bg">
          <div
            ...
            aria-label="Porcentaje de carga diaria"
            style={{
              width: `${percentage}%`,
              backgroundColor:
                percentage >= 100
