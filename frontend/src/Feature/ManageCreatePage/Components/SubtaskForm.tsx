            ...
            <div className="subtask-form-container">
                ...
                <div className="subtask-form-input-section">
                    ...
                    <div className="subtask-form-row">
                        <div className="subtask-form-field">
                            <label htmlFor="planification_date">¿Qué día planeas hacer esto?</label>
                            <input
                                id="planification_date"
                                type="date"
                                className={`subtask-form-input ${errors.planification_date ? 'error' : ''}`}
                                value={formData.planification_date}
                                onChange={(e) => handleFieldChange('planification_date', e.target.value)}
                            />
                            {errors.planification_date && (
                                <span className="subtask-form-error">{errors.planification_date}</span>
                            )}
                        </div>
                        ...
                        <div className="subtask-form-field">
                            ...
                            <input
                                ...
                                onChange={(e) => handleFieldChange('needed_hours', parseFloat(e.target.value) || 0)}
                            />
                            {errors.needed_hours && (
                                <span className="subtask-form-error">{errors.needed_hours}</span>
                            )}
                        </div>
                    </div>
